...
if __name__ == '__main__':
    ...
    model = CellposeModel(gpu=True, pretrained_model=None,  net_avg=False, diam_mean=17.,
    ...
    cpmodel_path = model.train(images, labels, train_files=None,
                               ...
                               test_files=None, channels=None, normalize=True,
                               save_path=save_path, save_every=1, save_each=True,
